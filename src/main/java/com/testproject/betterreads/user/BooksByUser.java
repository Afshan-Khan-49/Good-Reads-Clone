...
public class BooksByUser {
    ...
    public String toString() {
        return "BooksByUser [authorNames=" + authorNames + ", bookId=" + bookId + ", bookName=" + bookName
                + ", coverIds=" + coverIds + ", coverUrl=" + coverUrl + ", id=" + id + ", rating=" + rating
                + ", readingStatus=" + readingStatus + ", timeUuid=" + timeUuid + "]";
    }
